...
\documentclass[12pt]{report}         %% LaTeX2e document.
                                     %% keep 12pt to be within 2020 format specification
...
%%This page is optional—must be placed in this order if it is included in the dissertation. If you don’t want to include a glossary, then delete the entire page and the following page break.
\printglossaries
